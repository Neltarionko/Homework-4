...
def clicked3(): 
    ...
    main(radiobeacons, pseudorange)

window = Tk()
window.title("Radiobeacons GUI")
window.geometry('900x150') 
lbl = Label(window, text="Введите значения координат приемника и псевдодальностей (не менее 5):")  
...
lbl = Label(window, text="*Значения данных хранятся в файле data.txt*")  
