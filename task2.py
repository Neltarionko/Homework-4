...
pseudorange = [199.4139, 380.6324, 967.4691, 825.1122, 821.5541]
...
l1, l2, l3 = heapq.nsmallest(3, range(len(len_inter)), key = len_inter.__getitem__)
data_new = [list1[l1], list1[l2], list1[l3]]
...
for i in range(len(radiobeacons)):
    ...
    globals()['circle_%s' % i] = plt.Circle(radiobeacons[i], pseudorange[i]+noise[i], color='b', fill=False, linestyle='--')
